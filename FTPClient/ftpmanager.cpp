...
//    closesocket(file_socket);
    ...
    UploadThread *uploadtheread = new UploadThread(mainwindow,file_sock,filename);
    uploadtheread->start();
    closesocket(data_sock);
...
//    closesocket(data_sock);
    ...
    UploadThread *uploadthread = new UploadThread(mainwindow,data_sock,filename);
    uploadthread->start();
